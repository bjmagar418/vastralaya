...
import { Link } from "react-router-dom"; // Keeps routing uniform across your codebase
  ...
  return (
    <>
      <footer className="w-full bg-black text-white mt-8">
        <div className="max-w-[1400px] mx-auto px-6 py-10 lg:px-16">
          <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1.2fr_1fr_1fr_1.2fr_1.5fr]">
            ...
            <div className="flex flex-col items-center text-center gap-4 sm:col-span-2 lg:col-span-1 lg:items-start lg:text-left">
              <div className="flex flex-col items-center gap-2 lg:items-start lg:gap-1 border-b border-gray-700 pb-2 w-full lg:w-auto">
                <img
                  src={footerlogo}
                  alt="Vastralaya logo"
                ...
                <span className="font-extrabold text-base leading-tight tracking-wide uppercase">
                  Vastralaya
                  <br />
                  <span className="font-normal text-xs text-white tracking-widest normal-case block mt-0.5">
                    Redefine Your Style
                  </span>
                </span>
              </div>
            ...
            <div className="flex flex-col items-center text-center gap-2 lg:items-start lg:text-left">
              ...
              {["About Us", "Contact Us", "Our Stores", "Careers"].map((item) => (
                <Link key={item} to="/" className="text-sm text-gray-300 hover:text-red-400 transition-colors">
                  {item}
                </Link>
              ))}
            </div>
            ...
            <div className="flex flex-col items-center gap-3 lg:items-start">
              ...
              <div className="grid grid-cols-2 gap-3 w-[160px] lg:w-full">
                {[
                  ...
                  <div
                    key={alt}
                    className="h-[44px] lg:h-[52px] bg-white rounded-lg p-1.5 cursor-pointer
                               hover:ring-2 hover:ring-red-400 transition-all flex items-center justify-center"
                  >
                    <img
                      src={src}
                      alt={alt}
        ...
        {/* Copyright */}
        <div className="bg-black text-center text-gray-400 text-xs py-4 px-4 tracking-wide">
