...
const CartModel = ({ onClose }) => {
  const { cart, removeFromCart, changeQty, totalItems } = useCart();
                ...
                <div key={item._id} className="border-b border-gray-100 last:border-b-0">
                  ...
                  <div className="hidden sm:grid grid-cols-12 px-5 py-4 items-center">
                    ...
                    <div className="col-span-1 flex justify-center">
                      <button onClick={() => removeFromCart(item._id)} className="text-gray-400 hover:text-red-500 transition p-1">
                        <FaTrash size={15} />
                      </button>
                    </div>
                  </div>

                  {/* MOBILE ROW — centered card style */}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                          <div>
                            ...
                            <span className="inline-block mt-1 text-xs bg-green-50 text-green-700 rounded px-2 py-0.5">In Stock</span>
                          </div>
                          <button onClick={() => removeFromCart(item._id)} className="text-gray-300 hover:text-red-500 transition flex-shrink-0 mt-0.5">
                            <FaTrash size={14} />
                          </button>
                        </div>
