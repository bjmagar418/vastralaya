...
import { useDeleteProductMutation, useFetchAllProductsQuery } from "../../../../redux/features/products/productsApi.js";
...
const ManageProduct = () => {
  ...
  //pagination to show the differetn products in single one
 ...
 if(pageNumber > 0 && pageNumber <= totalPages){
  ...
  <section className="py-1 bg-blueGray-50">
                <div className="w-full  mb-12 xl:mb-0 px-4 mx-auto">
                    <div className="relative flex flex-col gap-2 min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
                                        ...
                                        products && products.map((product, index) => (
                                            <tr key={index}>
                                                ...
                                                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 cursor-pointer  ">
                                                    <Link to={`/dashboard/update-product/${product._id}`} className="bg-red-500 p-1.5 text-white hover:bg-amber-500"> Edit</Link>
                                                </td>
                                                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                    <button
